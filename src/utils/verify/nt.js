  ...
  //  define([], r) : "object" == typeof exports ? exports.initNECaptcha = r() : 
   t.initNECaptcha = r()
    ...
    function (t, r, n) {
        ...
        function (t) {
            ...
            h = {
                script: function (t, r) {
                    var n = this;
                    this.cacheTime && (t = t + "?v=" + p(this.cacheTime)),
                    i(t, {
                        charset: "UTF-8"
                    }, function (e, o) {
                        var i = n.detectKey;
    ...
    function (t, r) {
        ...
        r.FEEDBACK_URL = "http://support.dun.163.com/feedback/captcha",
        r.RUN_ENV = {
            WEB: 10,
            ANDROID: 20,
            IOS: 30,
        ...
        var n = {}.toString,
            e = {
                ...
                msie: function o() {
                    ...
                    return isNaN(o) && (o = parseInt((/trident\/.*; rv:(\d+)/.exec(t.toLowerCase()) || [])[1])),
                    o
                },
                now: function () {
    ...
    function (t, r, n) {
        ...
        var o, i = n(6),
            ...
            d = n(9),
            y = d.uuid,
            v = (o = {}, e(o, s, "api"), e(o, l, "image"), e(o, u, "script"), e(o, f, "business"), o),
            m = null;
        t.exports = function (t, r, n) {
                var e = r.protocol,
                    ...
                    g = d(o || u.apiServer || ["c.dun.163yun.com", "c.dun.163.com"]),
                    _ = i({
                        timeout: l,
                        disableRetry: !0
                    }),
                ...
                var O = e + "://only-d-" + y(32) + "-" + (new Date).valueOf() + ".nstool.netease.com/ip.js";
                return h.script({
                        url: O,
                        timeout: l,
                        checkResult: function (t) {
                            ...
                            var r = new p;
                            return m && m.dns ? (r.resolve(), r) : (setTimeout(function () {
    ...
    function (t, r) {
        ...
        function e(t, r, e, a) {
            ...
            "object" === ("undefined" == typeof e ? "undefined" : o(e)) && (a = e, e = null),
    ...
    function (t, r, n) {
        function e(t, r, n) {
            ...
            var v = function (r) {
                ...
                g = y[m] || i.script({
                    id: m,
                    url: v(t.staticServer || ["cstaticdun.126.net", "cstatic.dun.163yun.com"]),
                    timeout: t.timeout,
                    cacheTime: f,
                    onTryError: p(t),
                    detectKey: h("plugins")
    ...
    function (t, r, n) {
        ...
        function (t) {
            ...
            d = n(5),
            y = d.CACHE_MIN,
            v = u.REQUEST_API_ERROR,
            m = u.REQUEST_SCRIPT_ERROR,
            g = u.UNKNOWN_ERROR,
            _ = !1;
        l(o, s),
        Object.assign(o.prototype, {
                ...
                catchError: function (t, r) {
                    if (!this._error) {
                        var n = new u(r || g, t.message, t.data);
                        this._error = n,
                        this.emit("error", n)
                    }
                }
    ...
    function (t, r) {
        Array.prototype.map || (Array.prototype.map = function (t, r) {
            ...
            for (r && (n = r), e = new Array(a), o = 0; o < a;) {
                    var c, u;
                    o in i && (c = i[o], u = t.call(n, c, o, i), e[o] = u),
                    o++
                }
            return e
        })
