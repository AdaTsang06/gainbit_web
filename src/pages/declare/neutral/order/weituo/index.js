...
import { neutralStatusSel, deliverTypeSel } from '../../../../../common/search-item';
...
class WeiTuo extends PureComponent {
    constructor(props) {
        ...
        this.state = {
            ...
            symbolid: '',
            orderStatusNow: neutralStatusSel[0].value,
    ...
    cancelOrder = id => {
        this.props.dispatch({
            type: 'neutralDeclare/cancelOrder', payload: { neutralid: id }
        })
    };
    ...
    toSearch = (paramsObj) => {     
        const { symbolid,start, end, acId,orderStatusNow, settleTypeNow } = this.state;
        paramsObj={
            accountid: acId,
            symbolid: symbolid,
            start_time: start,
        ...
        paramsObj.limit = 10;
        this.props.dispatch({ type: 'neutralDeclare/queryNeutral', payload: paramsObj });
    }
    render() {
        const {
            acSymbolsObj,
        ...
        return (
            <div className={classnames(styles.container)}>
                <div className={styles.history}>
                    ...
                    <Order _historySearch={this._historySearch} _paginationCallback={this._paginationCallback} 
                    cancelOrder={this.cancelOrder} init={init}/>
                </div>
            </div>
        );
    }
