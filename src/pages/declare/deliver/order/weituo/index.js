...
import { deliverStatusSel, deliverTypeSel } from '../../../../../common/search-item';
...
class WeiTuo extends PureComponent {
    ...
    cancelOrder = id => {
        this.props.dispatch({
            type: 'deliverDeclare/cancelOrder', payload: { deliverid: id }
        })
    };
    ...
    toSearch = (paramsObj) => {
        ...
        paramsObj.limit = 10;
        this.props.dispatch({ type: 'deliverDeclare/queryDeliver', payload: paramsObj });
    }
    render() {
        const {
            acSymbolsObj,
